...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_300/v1676878048/Blogsite1/unity/deployingtocloud/image_1_co4xmc.png)![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_300/v1676878048/Blogsite1/unity/deployingtocloud/image_2_mhaehy.png)![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_300/v1676878047/Blogsite1/unity/deployingtocloud/image_3_d6mwtl.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_450/v1676878048/Blogsite1/unity/deployingtocloud/image_5_lqulud.png){: .align-center}{: .text-nowrap}
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_450/v1676878049/Blogsite1/unity/deployingtocloud/image_6_ca0unr.png)![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_450/v1676878049/Blogsite1/unity/deployingtocloud/image_7_ptlqzo.png){: .align-center}{: .text-nowrap}

#### Creating and Deploying the Docker Image:

    * Copy the Docker Creds from [PlayFab developer account](https://developer.playfab.com/)

            ![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_450/v1676878047/Blogsite1/unity/deployingtocloud/image_8_zzs3sd.png)![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/c_scale,w_450/v1676878049/Blogsite1/unity/deployingtocloud/image_9_jbrowe.png)
...
*example: **cd mnt/c/Code/Kevuru/battle-axes/Builds/server5/*

    * run the login command 

*example: **docker login -u <username_here> -p <password_here> <url_here>*

* run the build docker image command

*example: **docker build -t <url_here>/battleaxes_server:v1 . ** *

*(Note: there is a "." in the end of above command which means all files in the directory)*

*(Note: increment v1 (vX) based on previously uploaded version)*
...
*example: **docker push <url_here>/battleaxes_server:v1*
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878048/Blogsite1/unity/deployingtocloud/image_10_nylant.png)
...
*example: **ssh <id_here>@<ip_here> -p <port_here>*

* Run the Docker ps to get current running container info

*example: **sudo docker ps -a*
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878046/Blogsite1/unity/deployingtocloud/image_11_mfdk0m.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878047/Blogsite1/unity/deployingtocloud/image_13_mtxtp3.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878049/Blogsite1/unity/deployingtocloud/image_14_wxur4r.png)![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878049/Blogsite1/unity/deployingtocloud/image_15_imu4ew.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878049/Blogsite1/unity/deployingtocloud/image_16_fblvj2.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878047/Blogsite1/unity/deployingtocloud/image_17_ddjguf.png)

* Now open a second client and click on "**Join Game**" button, enter the configuration you received above

![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878047/Blogsite1/unity/deployingtocloud/image_18_kc8i3q.png)
...
![image alt text](https://res.cloudinary.com/dwfkishzf/image/upload/v1676878049/Blogsite1/unity/deployingtocloud/image_19_rxypqg.png)